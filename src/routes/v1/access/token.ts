...
import JWT, { TokenType } from '../../../core/JWT';
...
router.post(
  ...
  asyncHandler(async (req: ProtectedRequest, res) => {
    ...
    const accessTokenPayload = await JWT.decode(req.accessToken, TokenType.access);
    ...
    const refreshTokenPayload = await JWT.validate(req.body.refreshToken, TokenType.refresh);
